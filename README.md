...
* OpenCV 3.0.0 (Higher version should work), 
* UBUNTU 16.04. -->


<!-- ## Potential Shortcomings

* The paths cannot be established without continuity.
* There's no path planning for keypoints which are not defined by a segment in the csv configuration file.
* The robot cant turn and move at the same time. -->


<!-- ## Possible Improvements
* The software made is the base structure for trajectory simulation, obstacle detection, Path Planning, control theory, etc.  
* Crossing streets with smooth movement, for example, use splines for that even lines.
* Set a splines to make Path Planning algorithms.

If you want to make some improvement in the code, use Pull Request section in this repository with a full description. Please use functions. -->
